 ...
 * Use the [FragmentAddTeacher.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentAddTeacher : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentAddTeacher.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentAddTeacher().apply {
